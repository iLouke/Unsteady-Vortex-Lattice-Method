...
contains
    ...
    !> \param   gama  Circulation strength (CCW positive)
    ...
    pure function point_vortex_2D(p, p0, gama) result(vel)
        ...
        if (r2 < ZERO) then
            ...
            ! CCW Convention: u = -gama/2pi * dy/r^2, v = gama/2pi * dx/r^2
            vel(1) = -(gama / (TWO_PI * r2)) * r_vec(2)
            vel(2) =  (gama / (TWO_PI * r2)) * r_vec(1)
        end if
    ...
    !> \param   gama  Circulation per unit length
    !> =========================================================================
    ...
    !> \param   gama  Circulation strength
    !> =========================================================================
